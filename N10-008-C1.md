...
What is SMTP stand for? What is it used for?\
  - Figure 1-36 - Connection between client and server\

__Page 29__\
What do TC/IP protocols not do before sending data? WHat is an example?\
 - Figure - Contionless communication\
What is connection-oriented protocol?\
What is connectionless protocol?\

 __Segments with Packets__\
